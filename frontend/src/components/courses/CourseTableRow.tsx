  ...
  return (
    ...
    >
      ...
      <td style={{ padding: '16px', color: '#4299e1' }}>
        <a href={course.website} target="_blank" rel="noopener noreferrer" title="Open course website">
          <Link size={18} />
        </a>
      </td>
      <td style={{ padding: '16px', color: '#ed8936' }}>
        <a href={course.playlist} target="_blank" rel="noopener noreferrer" title="Open playlist">
          <Play size={18} />
        </a>
      </td>
    </tr>
